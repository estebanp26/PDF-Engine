...
export default function ViewerTab({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 p-3 bg-slate-50 dark:bg-slate-850 rounded-lg border border-slate-200 dark:border-slate-800">
        ...
        <div className="flex items-center gap-2">
          {highlightQuery && (
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1 text-xs font-medium rounded border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-100 transition"
          ...
          <button
            ...
            className="flex items-center gap-1 px-3 py-1 text-xs font-medium rounded border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-100 disabled:opacity-40 transition"
          >
      ...
      {/* Page Image Viewport */}
      <div className="flex justify-center items-center bg-slate-200 dark:bg-slate-950 p-4 sm:p-8 rounded-lg border border-slate-300 dark:border-slate-800 min-h-[500px] overflow-auto">
        {previewUrl ? (
          <img
            src={previewUrl}
            alt={`Página ${activePage}`}
            className="max-w-full max-h-[820px] object-contain bg-white shadow-md border border-slate-300 dark:border-slate-800 rounded transition"
            loading="lazy"
          />
        ) : (
